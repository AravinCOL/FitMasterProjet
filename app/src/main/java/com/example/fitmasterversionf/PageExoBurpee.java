...
public class PageExoBurpee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_exo_burpee);
                ...
                if ((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 3000) { //Pour exo de 30s ca coupe
                    ...
                    buttNext.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent np = new Intent(PageExoBurpee.this, PageExoSquateFenteBulgare.class);
                            startActivity(np);
                        }
                    });

                    Toast.makeText(PageExoBurpee.this, "Bravo!", Toast.LENGTH_SHORT).show();
