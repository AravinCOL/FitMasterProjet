...
public class PageExo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_exo);
                ...
                if ((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 3000) { //Pour exo de 30s ca coupe
                    ...
                    buttNext.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent pageExoPlanche = new Intent(PageExo.this, PageExoPlank.class);
                            startActivity(pageExoPlanche);
                        }
                    });

                    Toast.makeText(PageExo.this, "Bing!", Toast.LENGTH_SHORT).show();
