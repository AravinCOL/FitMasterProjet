...
public class PageExoSquateFenteBulgare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_exo_squate_fente_bulgare);
                ...
                if ((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 3000) { //Pour exo de 30s ca coupe
                    ...
                    buttNext.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent np = new Intent(PageExoSquateFenteBulgare.this, PageExoPlank.class);
                            startActivity(np);
                        }
                    });

                    Toast.makeText(PageExoSquateFenteBulgare.this, "Bravo!", Toast.LENGTH_SHORT).show();
