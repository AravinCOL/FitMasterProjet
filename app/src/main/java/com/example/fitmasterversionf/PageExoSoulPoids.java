...
public class PageExoSoulPoids extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_exo_soul_poids);
                ...
                if ((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 3000) { //Pour exo de 30s ca coupe
                    ...
                    buttNext.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent np = new Intent(PageExoSoulPoids.this, PageExoBurpee.class);
                            startActivity(np);
                        }
                    });

                    Toast.makeText(PageExoSoulPoids.this, "Bravo!", Toast.LENGTH_SHORT).show();
