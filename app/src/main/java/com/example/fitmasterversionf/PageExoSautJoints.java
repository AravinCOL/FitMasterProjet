...
public class PageExoSautJoints extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_exo_saut_joints);
                ...
                if ((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 3000) { //Pour exo de 30s ca coupe
                    ...
                    buttNext.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent np = new Intent(PageExoSautJoints.this, PageExoSquatSaute.class);
                            startActivity(np);
                        }
                    });

                    Toast.makeText(PageExoSautJoints.this, "Bravo!", Toast.LENGTH_SHORT).show();
