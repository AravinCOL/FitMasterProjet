...
public class PageExoPompes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_exo_pompes);
                ...
                if ((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 3000) { //Pour exo de 30s ca coupe
                    ...
                    buttNext.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent np = new Intent(PageExoPompes.this, PageExoSautJoints.class);
                            startActivity(np);
                        }
                    });

                    Toast.makeText(PageExoPompes.this, "Bravo!", Toast.LENGTH_SHORT).show();
